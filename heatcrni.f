      PROGRAM HEATCRNI
C *******************************************************************
C  THIS PROGRAM DIFFERS FROM HEATEX WHICH CAN SOLVE THE SAME PROBLEM 
C  USING THE EXPLICIT METHOD ONLY IN THE SUBROUTINE 'CYCLE.
C ******************************************************************* 
...
C  ******************************************************************
C  THIS USES THE CRANK-NICHOLSON METHOD TO SOLVE THE PROBLEM OF THE
C  TEMPERATURE VARIATION IN A LAGGED BAR WITH BOUNDARY CONDITIONS
C  GIVING THE TEMPERATURE AT THE ENDS OF THE BAR EITHER FIXED OR
C  AS SOME FUNCTION OF TIME.   THE BOUNDARY CONDITIONS FOR THE 
C  LEFT AND RIGHT-HAND ENDS OF THE BAR ARE GIVEN BY FUNCTION 
